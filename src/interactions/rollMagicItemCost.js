...
const rollMagicItemCost = (rarity) => {
    ...
    if (rarity === "common") {
        ...
        return `Common magic item cost: ${magicItemCost} gp`

    } else if (rarity === "uncommon") {
        magicItemCost = rollDice(6) * 100;
        return `Uncommon magic item cost: ${magicItemCost} gp`

    } else if (rarity === "rare") {
        magicItemCost = (rollDice(10) + rollDice(10)) * 1000;
        return `Rare magic item cost: ${magicItemCost} gp`

    } else if (rarity === "very-rare") {
        magicItemCost = (rollDice(4) + 1) * 10000;
        return `Very rare magic item cost: ${magicItemCost} gp`

    } else if (rarity === "legendary") {
        magicItemCost = (rollDice(6) + rollDice(6)) * 25000;
        return `Legendary magic item cost: ${magicItemCost} gp`
